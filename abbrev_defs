...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("als" "self-reported life satisfaction average " nil 6)
    ("bel" "*belief-about-right-wrong*" nil 4)
    ("bge" "best-guess-estimate" nil 1)
    ("ce" "Charity Entrepreneurship" nil 59)
    ("cef" "cost-effectiveness" nil 1)
    ("ceff" "cost-effectiveness" nil 40)
    ("ch" "**Checklist**: sub; Yes; pre; Yes; ecm; Yes;" nil 259)
    ("cl" "**Claim**:" nil 599)
    ("cpls" "Cost per life saved" nil 11)
    ("cuz" "*because-should-due-to*" nil 17)
    ("def" "**Definition**:" nil 52)
    ("deun" "*definition-unclear*" nil 22)
    ("dol" "`$`" nil 96)
    ("dtw" "Deworming the world" nil 3)
    ("etg" "Earning-To-Give" nil 14)
    ("ex" "**Example-sub**: 
...
**Time**:" nil 283)
    ...
    ("gd" "Give Directly" nil 15)
    ("gw" "GiveWell" nil 218)
    ("hasex" "*unsure-if-it-has-example*" nil 1)
    ("hli" "Happier
Lives Institute" nil 0)
    ("hoto" "**How-to-tackle**:" nil 0)
    ("imp" "*a-is-important*" nil 1)
    ...
    ("mus" "*must*" nil 1)
    ("nl" "Netherlands" nil 9)
    ("noex" "*no-example*" nil 135)
    ("nt" "**Note**:" nil 17)
    ("oft" "*often*" nil 1)
    ("owid" "Our World In Data" nil 2)
    ("pat" "**Pattern**:" nil 76)
    ("pr" "**Predicate**:" nil 82)
    ("rec" "**re-write Claim**:" nil 140)
...
**Time**:" nil 161)
    ("upgp" "Ultra Poor Graduation program " nil 1)
   ))
